...
-- CreateIndex
CREATE INDEX "Bateau_userId_idx" ON "Bateau"("userId");
...
-- AddForeignKey
ALTER TABLE "Bateau" ADD CONSTRAINT "Bateau_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
